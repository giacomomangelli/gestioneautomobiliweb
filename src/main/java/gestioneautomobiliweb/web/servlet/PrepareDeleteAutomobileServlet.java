...
public class PrepareDeleteAutomobileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			request.setAttribute("delete_automobile_attr", MyServiceFactory.getAutomobileServiceInstance()
		...
		RequestDispatcher rd = request.getRequestDispatcher("/automobile/delete.jsp");
