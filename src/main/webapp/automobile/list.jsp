	...
	<main role="main" class="container">
		...
		<div class='card'>
		    <div class='card-header'>
		        <h5>Lista delle Automobili</h5> 
		    </div>
		    <div class='card-body'>
		    	<a class="btn btn-primary " href="PrepareInsertAutomobileServlet">Aggiungi Nuova</a>
		        ...
		        <div class='table-responsive'>
		            <table class='table table-striped ' >
		                ...
		                <tbody>
		                <c:forEach var="automobileItem" items="${listaAutomobiliAttribute}">
		                    ...
		                    <tr >
		                        ...
		                        <td>
							    	<fmt:formatDate var = "dataDiImmatricolazioneParsed"
								  		value = "${automobileItem.dataDiImmatricolazione}"  type = "date" pattern = "dd/MM/yyyy" />    
				                 		${dataDiImmatricolazione}
								</td>
		                        <td>
									<a class="btn  btn-sm btn-outline-secondary" href="ExecuteShowAutomobileServlet?idAutomobile=${automobileItem.id}">Visualizza</a>
